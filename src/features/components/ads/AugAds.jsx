  ...
  return (
    <section className="w-full py-16">
      <div className="mx-auto max-w-[1600px] px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16">
        <div
          ref={ref}
          className={`bg-[#000000] text-[#FFFFFF] rounded-xl pre-animate${visible ? " animate-slide-in-left" : ""}`}
        >
          <div className="px-4 py-8 sm:px-6 sm:py-10 md:px-8 md:py-12 lg:px-12 lg:py-14 xl:px-16">
            <h3 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-[56px] font-medium leading-tight text-[#FFFFFF] max-w-2xl">
              {title}
            </h3>
            <button
