            ...
            {showImage && (
              <div className="relative flex items-center justify-center h-[280px] sm:h-[320px] md:h-[350px] hover-popup">
                ...
                <img
                  ...
                  className="absolute inset-0 w-full h-full object-contain transform translate-y-10"
                />
                ...
                <div className="relative z-10 w-3/5 sm:w-1/2">
                  <img
                    ...
                    className="w-full h-auto object-contain rounded-lg shadow-lg transform translate-y-10"
                  />
                </div>
              </div>
            )}
